...
export function PromptsTable(props: PromptsTableProps) {
  ...
  return (
    <div
      className={cn('w-full overflow-hidden  border-white/10  backdrop-blur shadow-lg', className)}
    >
          ...
          <TableBody>
            {prompts.length === 0 ? (
              <TableRow className="border-white/5">
                <TableCell className="px-4 py-8 text-center text-sm text-white/50" colSpan={2}>
