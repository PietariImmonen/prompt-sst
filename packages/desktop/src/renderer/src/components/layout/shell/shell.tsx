...
function Sidebar({ children, className }: React.ComponentPropsWithoutRef<'div'>) {
  return (
    <div
      className={cn(
...
export function Root(props: { children: React.ReactNode; header?: React.ReactNode }) {
  ...
  return (
    <div className="flex h-dvh max-h-dvh flex-1 flex-col">
      <div className={cn('grid min-h-0 flex-auto', sidebar && 'xl:grid-cols-[1fr_380px]')}>
