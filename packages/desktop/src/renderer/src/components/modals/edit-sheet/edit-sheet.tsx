...
export function EditSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className={cn('gap-0 p-0', className)} aria-describedby={undefined}>
        ...
        <ScrollArea className="flex h-full flex-1 flex-col overflow-y-auto">{children}</ScrollArea>
